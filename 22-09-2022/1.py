...
# method
# is named after Julius Caesar, who used it to communicate with his generals. ROT-13 ("rotate
# by 13
# places") is a widely used example of a Caesar cipher where the shift is 13. In Python, the key
# for
...
capital_alphabets_list = list(capital_alphabets)

alphabets_list.extend(capital_alphabets_list)
